...
function shellcommand_advanced_execution(root_doc, toobserve, toupdate) {
    ...
    var command_group = $("form[name='" + toobserve + "'] select[name='plugin_shellcommands_commandgroups_id']").val();
    ...
    $.each(items, function (index, option) {
        ...
        var items_id = $("div[id='" + option.id + "'] select[name='items_id']");
    ...
    var params = {
         'command_type': 'PluginShellcommandsAdvanced_Execution',
