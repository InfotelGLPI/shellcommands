...
xgettext *.php */*.php --copyright-holder='Shellcommands Development Team' --package-name='GLPI - Shellcommands plugin' --package-version='2.1.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
